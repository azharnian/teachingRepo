...
def save_btn():
	...
	if name and origin and birth_place:
		...
		origin_var.set("")
		birth_place_var.set("")
		msg_label.configure(text="Data Siswa Tersimpan", fg="green")
		return True
	msg_label.configure(text="Pastikan data siswa telah diisi.", fg="red")
	return False
...
month_var = StringVar()
month_combobox = Combobox(birth_date_frame, width=15, textvariable=month_var)
...
year_combobox["values"] = list(range(2000,2026))
...
save_btn.grid(row=7, column=0, columnspan=2, sticky="e")
