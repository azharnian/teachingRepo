...
class LoginPage(Frame):
	...
	def create_login_frame(self):
		...
		self.login_frame.grid(row=1, column=0, sticky="nesw", padx=30)

		self.login_frame.grid_columnconfigure(0, weight=1)
		self.login_frame.grid_columnconfigure(1, weight=2)
		
		# bg = background , fg = foreground
		self.label_error = Label(self.login_frame, text="", font=("Arial", 9), bg="white", fg="red")
		self.label_error.grid(row=0, column=0, columnspan=2, sticky="nsew")
		...
		self.entry_username_frame.grid(row=1, column=1, sticky="nesw")
		...
		self.entry_password_frame.grid(row=2, column=1, sticky="nesw")
		...
		self.login_button.grid(row=3, column=0, columnspan=2, sticky="nesw", padx=100, pady=10)
