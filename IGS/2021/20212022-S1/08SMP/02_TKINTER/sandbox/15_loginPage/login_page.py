...
class LoginPage(Frame):
	...
	def create_login_frame(self):
		...
		self.login_frame.grid(row=1, column=0, sticky="nsew", padx=20)
		...
		self.login_button = Button(self.login_frame, text="Masuk", font=("Arial", 12), command=self.click_login_button)
